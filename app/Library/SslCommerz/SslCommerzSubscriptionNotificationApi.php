...
class SslCommerzSubscriptionNotificationApi extends AbstractSslCommerz {
    protected $data   = [];
    protected $config = [];
...
// Here we will define the response pattern
    ...
    protected function setSuccessUrl() {
        $this->successUrl = url('/') . $this->config['subscription_success_url'];
    }
    ...
    protected function setFailedUrl() {
        $this->failedUrl = url('/') . $this->config['subscription_failed_url'];
    }
    ...
    protected function setCancelUrl() {
        $this->cancelUrl = url('/') . $this->config['subscription_cancel_url'];
    }
