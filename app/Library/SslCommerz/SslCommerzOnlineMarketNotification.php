...
class SslCommerzOnlineMarketNotification extends AbstractSslCommerz {
    protected $data   = [];
    protected $config = [];
...
// Here we will define the response pattern
    ...
    protected function setSuccessUrl() {
        $this->successUrl = url('/') . $this->config['online_market_success_url'];
    }
    ...
    protected function setFailedUrl() {
        $this->failedUrl = url('/') . $this->config['online_market_failed_url'];
    }
    ...
    protected function setCancelUrl() {
        $this->cancelUrl = url('/') . $this->config['online_market_cancel_url'];
    }
