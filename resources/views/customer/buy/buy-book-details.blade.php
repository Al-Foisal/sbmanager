        ...
        <div class="container-fluid">
                                    ...
                                    <tr>
                                        <td style="vertical-align: middle;">
                                            ...
                                            @if ($transaction->supplier_id !== null)
                                                <b>{{ GET_CONSUMER_BY_ID($transaction->supplier_id)->name }}</b>
                                                <br>
                                            @endif
            ...
            <div class="row">
                ...
                <div style="width: 50%;float: left;text-align:right">
                    <a href="{{ route('customer.buy.cartOrder', Crypt::encryptString($transaction->id)) }}"
                    ...
                    <div class="card">
                        <div class="card-body">
                            <table id="" class="table  table-striped">
                                ...
                                <tbody>
                                    @foreach ($transaction->buyProduct as $product)
                                        <tr>
                                            <td style="vertical-align: middle;">
