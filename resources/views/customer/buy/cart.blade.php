        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div style="width: 50%;float: left;text-align:right">
                    <a href="{{ route('customer.buy.index') }}" class="btn btn-primary mb-2 text-right">Add
                            ...
                            <table id="" class="table table-striped">
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <th></th>
                                        <th>
                                            <a href="{{ route('customer.buy.checkout') }}" class="btn btn-primary btn-sm btn-block">Proceed to Checkout</span></a>
                                        </th>
                                    </tr>
                                </tfoot>
                            </table>
